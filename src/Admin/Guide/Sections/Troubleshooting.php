...
final class Troubleshooting {
	...
	public static function get(): Section {
		return new Section(
			...
			body: '<p>' . __( 'An order note reading <strong>"⚠ [SHORTAGE]"</strong> means that order\'s components were consumed even though one or more ran short — the sale itself was never blocked, since refusing a paid order would be worse than a stock discrepancy, but the physical inventory should be checked against what the order claims it needed.', 'wcbom' ) . '</p>'
