...
final class BuildingABom {
	...
	public static function get(): Section {
		return new Section(
			...
			blocks: array(
				Section::text(
					'<p>' . __( 'Open any product for editing and use its "Bill of Materials" tab to add lines. Each line picks a component (searched by name, or created inline if it does not exist yet) and a quantity. A live "buildable" count and cost estimate update as you edit.', 'wcbom' ) . '</p>'
				...
				Section::screenshot(
					...
					__( 'The Bill of Materials tab: the Weight from BOM and Cost of Goods Sold from BOM checkboxes, and the BOM lines with a surcharge, always/attribute conditions, and a live buildable/cost estimate.', 'wcbom' )
				),
				Section::text(
				...
				Section::screenshot(
					...
					__( 'A BOM line whose component is a manufactured sub-assembly product.', 'wcbom' )
				),
			),
			covers_routes: array(
