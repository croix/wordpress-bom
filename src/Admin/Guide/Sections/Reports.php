	...
	public static function get(): Section {
		return new Section(
			...
			blocks: array(
				...
				Section::screenshot( 'reports-low-stock.png', __( 'The Reports screen\'s Low Stock tab, including an on-order figure.', 'pv-bom-stock' ) ),
				Section::text( '<p>' . __( '<strong>Margin</strong> — BOM-derived cost versus price, per variation for made-to-order products, including any surcharges.', 'pv-bom-stock' ) . '</p>' ),
				Section::screenshot( 'reports-margin.png', __( 'The Reports screen\'s Margin tab.', 'pv-bom-stock' ) ),
				Section::text( '<p>' . __( '<strong>Component Usage</strong> — every component with its on-hand stock, unit of measure, and 30/90-day consumption with a simple days-of-stock estimate; searchable, and paginated once the list runs long.', 'pv-bom-stock' ) . '</p>' ),
			...
			links: array(
				array(
					'label' => __( 'Open Reports', 'pv-bom-stock' ),
