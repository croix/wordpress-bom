...
final class CsvImportExport {
	...
	public static function get(): Section {
		return new Section(
			...
			body: '<p>' . __( 'The Reports screen can export every BOM to a CSV file, keyed by SKU rather than internal ID — so a file exported from one site (or environment) can be imported into another where the IDs differ, as long as the SKUs match.', 'wcbom' ) . '</p>'
