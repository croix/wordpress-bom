...
final class Orientation {
	...
	public static function get(): Section {
		return new Section(
			...
			blocks: array(
				Section::text(
					'<p>' . __( 'This plugin adds Bill-of-Materials (recipe) and component-level stock tracking to WooCommerce. Three ideas explain almost everything else in this guide:', 'wcbom' ) . '</p>'
						. '<ul>'
				...
				Section::screenshot(
					...
					__( 'The BOM & Stock admin menu, showing Inventory, Manufacturing, Reports, Endpoints, and Settings.', 'wcbom' )
				),
			),
			links: array(
				array(
