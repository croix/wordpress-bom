		...
		return new Section(
			...
			blocks: array(
				...
				Section::screenshot(
					...
					__( 'The Component Inventory screen with no components yet, offering to install the sample catalog.', 'wcbom' )
				),
				Section::text(
				...
				Section::screenshot(
					...
					__( 'A product\'s Bill of Materials tab with "This product is a component" checked and a unit of measure chosen.', 'wcbom' )
				),
				Section::text(
