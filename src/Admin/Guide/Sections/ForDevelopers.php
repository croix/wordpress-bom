...
final class ForDevelopers {
	...
	public static function get(): Section {
		return new Section(
			...
			screenshots: array(
				array(
					'file' => 'endpoints-page.png',
					'alt'  => __( 'The Endpoints page listing every registered wcbom/v1 REST route live.', 'wcbom' ),
				),
			),
			links: array(
				array(
